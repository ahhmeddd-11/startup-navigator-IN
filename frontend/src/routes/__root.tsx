...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Startup Navigator — The intelligent operating system for Indian founders" },
      {
        name: "description",
        content:
          "AI-guided journeys, government schemes, DPIIT resources and expert playbooks for entrepreneurs building in India.",
      },
      { name: "author", content: "Startup Navigator" },
      { property: "og:title", content: "Startup Navigator — Navigate your startup journey" },
      {
